    ...
    <Container className={'shopBody'}>
      <Container className='card-items d-flex flex-wrap user-select-none' >
        <Card className='card-item mx-2'>
          ...
          <Card.Body className='p-2 text-wrap '>
            <Card.Title className='mb-0  text-smaller '>Card Title longer Text Longer and longer longer and longer and lonerg</Card.Title>
            <Card.Text className='m-0 text-large p-0'>&#8369;1,233,123.45 </Card.Text>
            <p className=' text-tiny'>81% discount off &#8369;12.65 </p>
            <h5 className='text-medium line-height-0'>252,122 sold</h5>
            <p className='text-small text-end'>Metro Manila</p>
          </Card.Body>
        </Card>
